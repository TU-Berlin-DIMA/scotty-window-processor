...
public final class TimeMeasure {
	...
	private TimeMeasure(long size, TimeUnit unit) {
		this.unit = unit;
		this.size = size;
	...
	public static TimeMeasure of(long size, TimeUnit unit) {
		return new TimeMeasure(size, unit);
	}

	/**
	 * Creates a new {@link TimeMeasure} that represents the given number of milliseconds.
	 */
	...
	/**
	 * Creates a new {@link TimeMeasure} that represents the given number of seconds.
	 */
	...
	/**
	 * Creates a new {@link TimeMeasure} that represents the given number of minutes.
	 */
	public static TimeMeasure minutes(long minutes) {
		return of(minutes, TimeUnit.MINUTES);
	}

	/**
	 * Creates a new {@link TimeMeasure} that represents the given number of hours.
	 */
	public static TimeMeasure hours(long hours) {
		return of(hours, TimeUnit.HOURS);
	}

	/**
	 * Creates a new {@link TimeMeasure} that represents the given number of days.
	 */
	public static TimeMeasure days(long days) {
